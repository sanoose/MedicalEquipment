...
function Store() {
  form.post(route('EquipmentsCards.store'), {
    onSuccess: () => toast.success('تمت إضافة الجهاز بنجاح'),
...
<template>
  <Head title="إضافة جهاز" />

  <div class="w-full py-10 px-10 bg-white" dir="rtl">
    <h1 class="text-3xl font-bold text-right mb-6">إضافة جهاز</h1>
    <hr />
    <br />
